      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <Link href="/jobs/new" className="block border rounded-xl p-6 hover:shadow-sm">
          ...
          <p className="opacity-70 text-sm mt-1">
            Create a new job and (optionally) invite a specific substitute.
          </p>
        </Link>
        ...
        <Link href="/principal/subs" className="block border rounded-xl p-6 hover:shadow-sm">
          <h2 className="font-semibold text-lg">View sub list</h2>
          <p className="opacity-70 text-sm mt-1">
            Browse substitutes and start a booking with one.
          </p>
        </Link>
      </div>
    </div>
